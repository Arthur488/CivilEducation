            ...
            <div class="col-lg-8 col-md-8 col-sm-10 text-center">
                <div class="section-heading mb-70">
                    ...
                    <p>
                        ...
                        або навпаки - зникли з поля зору, і це ускладнює пошук для тих, хто хоче звернутися за
                        допомогою.
                    </p>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-8 mt-50 text-center">
                <div class="single-feature-box">
                    ...
                    <div class="content">
                        ...
                        <p>Ми студенти, які навчаються в Національному університеті “Чернігівська політехніка” за
                            спеціальністю “Інженерія програмного забезпечення”. Ми створили цю платформу в рамках студентського проекту для 
                            інноваційного та інтерактивного курсу IFES з громадянської освіти "Демократія: від теорії до практики". Викладач Шакун Наталія Валеріївна. 
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-8 mt-50 text-center">
                <div class="single-feature-box">
                    ...
                    <div class="content">
                        ...
                        <p>Ми прагнемо допомогти людям, яким необхідна психологічна реабілітація після важких
                            переживань,
                            наприклад, військових дій. Ми хочемо полегшити їм пошук програм і ресурсів,
                            які допоможуть їм у одужанні. Наша мета - надати легкодоступну та точну інформацію
                            про ресурси,
                ...
                <div class="about-content mt-50">
                    ...
                    <div class="about-list mt-none-20">
                        <div class="single-item d-flex align-items-center mt-20">
                            ...
                            <span>7 Різних кваліфікованих фахівців з великим досвідом роботи</span>
                        </div>
                        <div class="single-item d-flex align-items-center mt-20">
                            <div class="icon">
                                <i class="fal fa-check"></i>
                        ...
                        <div class="single-item d-flex align-items-center mt-20">
                            ...
                            <span>Стежимо за трендами &amp; інноваціями в галузі психологічної реабілітації.</span>
                        </div>
                        <div class="single-item d-flex align-items-center mt-20">
                            <div class="icon">
                                <i class="fal fa-check"></i>
                            </div>
                            <span>Якість нашої роботи підтверджена позитивними відгуками наших клієнтів</span>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 text-center">
                <div class="section-heading mb-70">
                    ...
                    <p>Наша команда спеціалізується на наданні психологічної допомоги військовим та їхнім сім'ям.
                        Ми пропонуємо індивідуальний підхід до кожного клієнта і прагнемо допомогти їм у досягненні
                        життєвих цілей
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 mt-50 text-center">
                <div class="single-department">
                    ...
                    <div class="content">
                        ...
                        <p>Отримайте від нашої команди зворотній зв'язок. Підхід до кожного клієнта -
                            індивідуальний!</p>
                    </div>
                </div>
            </div>
...
<? require("mvc/view/modal_email.php"); ?>
